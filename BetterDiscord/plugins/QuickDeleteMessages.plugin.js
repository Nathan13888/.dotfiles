//META{"name":"QuickDeleteMessages","source":"https://gitlab.com/_Lighty_/bdstuff/-/blob/master/public/plugins/QuickDeleteMessages.plugin.js","website":"https://1lighty.github.io/BetterDiscordStuff/?plugin=QuickDeleteMessages","authorId":"239513071272329217","invite":"NYvWdN5","donate":"https://paypal.me/lighty13"}*//
/*@cc_on
@if (@_jscript)
...
module.exports = (() => {
  ...
  const buildPlugin = ([Plugin, Api]) => {
    ...
    return class QuickDeleteMessages extends Plugin {
      ...
      canDelete(props) {
        return props.message.author.id === DiscordAPI.currentUser.id || Permissions.can(DiscordModules.DiscordPermissions.MANAGE_MESSAGES, props.channel);
      }
